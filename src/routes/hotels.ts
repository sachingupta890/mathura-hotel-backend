...
const constructSearchQuery = (queryParams: any) => {
  ...
  // Check if nearByTemple is provided in queryParams
  ...
  // If destination (city or country) is still in query params, keep it as fallback
  // if (queryParams.destination) {
  //   constructedQuery.$or = [
  //     { city: new RegExp(queryParams.destination.trim(), "i") },
  //     { country: new RegExp(queryParams.destination.trim(), "i") },
  //   ];
  // }
